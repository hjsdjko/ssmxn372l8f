<template>
	<div class="main-content" :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}' class="select" label="车辆状态" prop="cheliangzhuangtai">
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"none","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">车辆状态</label>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('cheliangxinxi','签约')" @click="qianyuexinxiCrossAddOrUpdateHandler(scope.row,'cross','','','cheliangzhuangtai','已签约','已签约,未签约'.split(',')[0])" type="success">
		...
		<qianyuexinxi-cross-add-or-update v-if="qianyuexinxiCrossAddOrUpdateFlag" :parent="this" ref="qianyuexinxiCrossaddOrUpdate"></qianyuexinxi-cross-add-or-update>
...
import qianyuexinxiCrossAddOrUpdate from "../qianyuexinxi/add-or-update";
	export default {
		data() {
			return {
				...
				qianyuexinxiCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			qianyuexinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.qianyuexinxiCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.qianyuexinxiCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.qianyuexinxiCrossaddOrUpdate.init(row.id,type);
				});
			},
