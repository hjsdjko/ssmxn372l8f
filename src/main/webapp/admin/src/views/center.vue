<template>
  <div :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='siji'"  label="司机账号" prop="sijizhanghao">
          <el-input v-model="ruleForm.sijizhanghao" readonly              placeholder="司机账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='siji'"  label="司机姓名" prop="sijixingming">
          <el-input v-model="ruleForm.sijixingming"               placeholder="司机姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='siji'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='siji'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='siji'"  label="手机号码" prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma"               placeholder="手机号码" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='siji'"  label="身份证号" prop="shenfenzhenghao">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'siji' ==this.flag && this.ruleForm.shoujihaoma&&(!isMobile(this.ruleForm.shoujihaoma))){
        this.$message.error(`手机号码应输入手机格式`);
        return
      }


      if( 'siji' ==this.flag && this.ruleForm.shenfenzhenghao&&(!checkIdCard(this.ruleForm.shenfenzhenghao))){
